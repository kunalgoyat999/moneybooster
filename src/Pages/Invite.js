    ...
    <>
      <section className="invite-poster">
        <div className="header">
          <button onClick={() => (window.location.href = "/index")}>
            <img src={require("../assests/back.png")} alt="" />
          </button>
      ...
      <section>
        <div className="agent-reward">
          <p>Agent Rewards</p>
          <p>
            Level 1 = <span className="ref-bonus">Rs. 300</span>
          </p>
          <p>
            Level 2 = <span className="ref-bonus">Rs. 150</span>
          </p>
          <p>
            Level 3 = <span className="ref-bonus">Rs. 50</span>
          </p>
        </div>
      </section>
    </>
